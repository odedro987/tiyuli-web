...
export namespace tiyuli.expense {
  export class Expense extends pb_1.Message {
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
      ...
      if (this.has_note) writer.writeString(4, this.note)
      if (this.types.length) writer.writeRepeatedString(5, this.types)
      if (this.has_payment_date) writer.writeMessage(6, this.payment_date, () => this.payment_date.serialize(writer))
      if (this.currency_code.length) writer.writeString(7, this.currency_code)
      if (this.amount != 0) writer.writeFloat(8, this.amount)
